...
def test_website_only_names():
    assert standardize_company_name("b4g.baydin.com") == "b4g.baydin.com"
    assert standardize_company_name("gaggle.net") == "Gaggle.net"
    assert standardize_company_name("www.example.com") == "Example.com"
    assert standardize_company_name("app.sigecloud.com.br") == "app.sigecloud.com.br"
    assert (
        standardize_company_name("ehubsoft.herokuapp.com/golang")
        == "ehubsoft.herokuapp.com/golang"
    )


def test_multi_word_company_names():
    assert (
        standardize_company_name("Example Technologies Inc") == "Example Technologies"
    )
    ...
    assert (
        standardize_company_name("Innovative Systems Incorporated")
        == "Innovative Systems"
    )
...
def test_multi_word_company_names_with_website_info():
    assert (
        standardize_company_name("Example Technologies Inc https://example.com")
        == "Example Technologies"
    )
    assert (
        standardize_company_name("Advanced Solutions LLC www.advanced.com")
        == "Advanced Solutions"
    )
    assert (
        standardize_company_name("Creative Labs Ltd creativelabs.net")
        == "Creative Labs"
    )
    assert (
        standardize_company_name("Innovative Systems Incorporated innovative.org")
        == "Innovative Systems"
    )
    assert (
        standardize_company_name("Global Enterprises LLC global-enterprises.com")
        == "Global Enterprises"
    )
